function gui() {
    var N = 'bootstrap', O = 'begin', P = 'gwt.codesvr.gui=', Q = 'gwt.codesvr=', R = 'gui', S = 'startup', T = 'DUMMY',
        U = 0, V = 1, W = 'iframe', X = 'position:absolute; width:0; height:0; border:none; left: -1000px;',
        Y = ' top: -1000px;', Z = 'CSS1Compat', $ = '<!doctype html>', _ = '',
        ab = '<html><head><\/head><body><\/body><\/html>', bb = 'undefined', cb = 'readystatechange', db = 10,
        eb = 'script', fb = 'javascript', gb = 'Failed to load ', hb = 'moduleStartup', ib = 'scriptTagAdded',
        jb = 'moduleRequested', kb = 'meta', lb = 'name', mb = 'gui::', nb = '::', ob = 'gwt:property', pb = 'content',
        qb = '=', rb = 'gwt:onPropertyErrorFn', sb = 'Bad handler "', tb = '" for "gwt:onPropertyErrorFn"',
        ub = 'gwt:onLoadErrorFn', vb = '" for "gwt:onLoadErrorFn"', wb = '#', xb = '?', yb = '/', zb = 'img',
        Ab = 'clear.cache.gif', Bb = 'baseUrl', Cb = 'gui.nocache.js', Db = 'base', Eb = '//', Fb = 'gecko.variant',
        Gb = 'user.agent', Hb = 'gecko1_8', Ib = 'none', Jb = 'trident', Kb = 'ie11', Lb = 'std', Mb = 2, Nb = 'onLoad',
        Ob = 'default', Pb = 'webkit', Qb = 'safari', Rb = 'msie', Sb = 11, Tb = 'ie10', Ub = 9, Vb = 'ie9', Wb = 8,
        Xb = 'ie8', Yb = 'gecko', Zb = 3, $b = 4, _b = 'selectingPermutation', ac = 'gui.devmode.js',
        bc = '921A1238D7AA98A17ECCCC3531E2AFC6', cc = ':1', dc = ':2', ec = 'foobar', fc = ':3', gc = ':4', hc = ':5',
        ic = ':', jc = '.cache.js', kc = 'loadExternalRefs', lc = 'end', mc = 'http:', nc = 'file:', oc = '_gwt_dummy_',
        pc = '__gwtDevModeHook:gui', qc = 'Ignoring non-whitelisted Dev Mode URL: ', rc = ':moduleBase', sc = 'head';
    var n = window;
    var o = document;
    q(N, O);
    ...
    function A() {
        ...
        for (var g = U, h = f.length; g < h; ++g) {
            var i = f[g], j = i.getAttribute(lb), k;
            if (j) {
                j = j.replace(mb, _);
                if (j.indexOf(nb) >= U) {
                    continue
    ...
    function D() {
        ...
        j[Fb] = function () {
            try {
                if (!j.hasOwnProperty(Gb) || k(Gb) !== Hb) {
                    return Ib
                }
            } catch (a) {
                return Ib
            }
            if (navigator.userAgent.toLowerCase().indexOf(Jb) != -1) {
                return Kb
            }
            return Lb
        };
        i[Fb] = {'ie11': U, 'none': V, 'std': Mb};
        j[Nb] = function () {
            if (!n.marvin) {
                n.marvin = {
                    onLoadArray: [], onLoad: function () {
        ...
        i[Nb] = {'default': U, 'foobar': V};
        j[Gb] = function () {
            var a = navigator.userAgent.toLowerCase();
            var b = o.documentMode;
            if (function () {
                return a.indexOf(Pb) != -1
            }()) return Qb;
            if (function () {
                return a.indexOf(Rb) != -1 && (b >= db && b < Sb)
            }()) return Tb;
            if (function () {
                return a.indexOf(Rb) != -1 && (b >= Ub && b < Sb)
            }()) return Vb;
            if (function () {
                return a.indexOf(Rb) != -1 && (b >= Wb && b < Sb)
            }()) return Xb;
            if (function () {
                return a.indexOf(Yb) != -1 || b >= Sb
            }()) return Hb;
            return Qb
        };
        i[Gb] = {'gecko1_8': U, 'ie10': V, 'ie8': Mb, 'ie9': Zb, 'safari': $b};
    ...
    var G = D();
    if (n) {
        var H = !!(n.location.protocol == mc || n.location.protocol == nc);
        ...
        if (H && I()) {
            ...
            if (K && !n[J]) {
                ...
                L.src = K;
                var M = o.getElementsByTagName(sc)[U];
